...
import com.example.whatsapp_status_downloader_app.Adapter.FilesAdapter;
...
public class SavedFilesFragment extends Fragment {
    ...
    private void getFiles() {
        ...
        final File app_dir = new File(Environment.getExternalStorageDirectory() + File.separator + "/WS Downloader/");
